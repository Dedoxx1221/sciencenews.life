...
var campaignID = "66aab2706622860001eb4a57";
...
var initialSrc = "https://rt.hiddensecret.online/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("rt.hiddensecret.online/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://rt.hiddensecret.online/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://rt.hiddensecret.online/view?clickid=" + rtkClickID)
        xhrTrack.send();
